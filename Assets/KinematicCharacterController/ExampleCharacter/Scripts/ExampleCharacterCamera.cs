...
namespace KinematicCharacterController.Examples
{
    public class ExampleCharacterCamera : MonoBehaviour
    {
        ...
        [Range(-90f, 90f)]
        public float DefaultVerticalAngle = 0f; // Установите на 0 для вида сбоку
        [Range(-90f, 90f)]
        ...
        private RaycastHit[] _obstructions = new RaycastHit[32]; // Установите максимальное количество обструкций
        ...
        void Awake()
        {
            ...
            _targetVerticalAngle = DefaultVerticalAngle; // Установите фиксированный угол
        ...
        {
            FollowTransform = t;
            PlanarDirection = FollowTransform.right; // Смотрим сбоку
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                ...
                // Фиксированный угол для вида сбоку
                Quaternion verticalRot = Quaternion.Euler(DefaultVerticalAngle, 0, 0);
